...
public class Handlers
{
    ...
    private void registerUnitFunctions()
    {
        ...
        register(h("meta::pure::functions::meta::newUnit_Unit_1__Number_1__U_1_", true, ps -> res("meta::pure::metamodel::type::Any", "one"), ps -> typeOneMany(ps.get(0), "Any")));
        register(h("meta::pure::executionPlan::engine::java::convert_Any_1__Unit_1__U_1_", false, ps -> res("meta::pure::metamodel::type::Any", "one"), ps -> typeOneMany(ps.get(0), "Any")));
    }
    ...
    private Map<String, Dispatch> buildDispatch()
    {
        ...
        map.put("meta::pure::executionPlan::engine::java::convert_Any_1__Unit_1__U_1_", (List<ValueSpecification> ps) -> ps.size() == 2 && isOne(ps.get(0)._multiplicity()) && isOne(ps.get(1)._multiplicity()) && ("Nil".equals(ps.get(1)._genericType()._rawType()._name()) || "Unit".equals(ps.get(1)._genericType()._rawType()._name())));
        ...
        map.put("meta::pure::functions::meta::newUnit_Unit_1__Number_1__U_1_", (List<ValueSpecification> ps) -> ps.size() == 2 && isOne(ps.get(0)._multiplicity()) && ("Nil".equals(ps.get(0)._genericType()._rawType()._name()) || "Unit".equals(ps.get(0)._genericType()._rawType()._name())) && isOne(ps.get(1)._multiplicity()) && Sets.immutable.with("Nil", "Number", "Integer", "Float", "Decimal").contains(ps.get(1)._genericType()._rawType()._name()));
